...
#institutions
institution = Institution.create!(name: 'YPF', address:"CARACAS",city:'CAPITAL FEDERAL',province: 'BUENOS AIRES',number: 123, surface:120, workers_count:123, institutions_count:1, activity: 'ESTACION DE SERVICIO', contract: 'PEPELUI', postal_code: '1406', cuit: '30-12345678-2', phone_number: 45543212)
another_institution = Institution.create!(name: 'SHELL', address:"NEUQUEN",city:'CAPITAL FEDERAL',province: 'BUENOS AIRES',number: 532, surface:100, workers_count:123, institutions_count:1, activity: 'ESTACION DE SERVICIO', contract: 'LUZBELITO', postal_code: '1426', cuit: '30-12345678-4', phone_number: 45443212)
