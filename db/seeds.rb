...
user = User.create!(email: 'juan_perez@example.com', password: '12345678', password_confirmation: '12345678',
                    zone:flores)
another_user = User.create!(email: 'don_carlos@example.com', password: '12345678',
                            password_confirmation: '12345678', zone:caballito)
...
institution = Institution.create!(name: 'YPF', address:"CARACAS", city:'CAPITAL FEDERAL',
                                  ...
                                  postal_code: '1406', cuit: '30-12345678-2', phone_number: 45543212, latitude: 1.12345, longitude: 4.123456, zone:flores)
another_institution = Institution.create!(name: 'SHELL', address:"NEUQUEN",city:'CAPITAL FEDERAL',province: 'BUENOS AIRES',
                                          ...
                                          cuit: '30-12345678-4', phone_number: 45443212, latitude: 2.12345, longitude: 3.123456, zone:caballito)
